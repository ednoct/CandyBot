...
📩 | 要发送报告、建议或请求指导，请在 <b>Candy 群组</b>中留言：
...
⚠️ Candy 团队不对网关提供任何保证，所有使用和责任由您承担',
...
- 服务用户名：‌ {service_username}',
                ...
                'yesterday' => '☀️ 昨天',
                'apitetra' => '🧩 Tetra API',
                'minAmounttetra' => '💰 Tetra 最低金额',
                'maxAmounttetra' => '💸 Tetra 最高金额',
                'cashbacktetra' => '🎁 Tetra 返现设置',
                'setEducationtetra' => '📚 设置 Tetra 教程',
                'tetraGateway' => '🌐 Tetra 网关',
